...
gnome-terminal -- bash -c "DISPLAY=:1 chromium-browser 'http://localhost:5000' 'Press Enter to exit'; read"
gnome-terminal -- bash -c "DISPLAY=:0 chromium-browser 'http://localhost:5000/robot_view' 'Press Enter to exit'; read"
